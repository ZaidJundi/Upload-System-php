...
if(isset($_POST['submit'])!=""){//يعني اذا تم اررسال الملف الى الداتا بيس وكان ئيمته مش نال خليه يكمل
  ...
  if($chk){
	...
	while($c == 0){
    	$i++;
    	$reversedParts = explode('.', strrev($name),2);//explode زي التوكونايزر بتطبع نقطة بعدين امتداد الملف
